...
- Name: bloc5-jobmatch.spec.ts >> Bloc 5 — Job Match Panel >> 5.4-5.6 — Analyse d'offre retourne des suggestions priorisées
- Location: tests\bloc5-jobmatch.spec.ts:67:7
