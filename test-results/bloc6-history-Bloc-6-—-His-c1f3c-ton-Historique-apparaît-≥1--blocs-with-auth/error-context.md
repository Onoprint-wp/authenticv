...
- Name: bloc6-history.spec.ts >> Bloc 6 — Historique de Versions >> 6.2 — Après modification + save, bouton Historique apparaît (≥1)
- Location: tests\bloc6-history.spec.ts:31:7
