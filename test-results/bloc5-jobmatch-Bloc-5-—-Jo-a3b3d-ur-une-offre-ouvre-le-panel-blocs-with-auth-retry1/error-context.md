...
- Name: bloc5-jobmatch.spec.ts >> Bloc 5 — Job Match Panel >> 5.1 — Bouton 'Optimiser pour une offre' ouvre le panel
- Location: tests\bloc5-jobmatch.spec.ts:38:7
...
Locator: locator('[data-testid=\'job-match-panel\']')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[data-testid=\'job-match-panel\']')
  ...
  - generic [ref=e2]:
    - banner [ref=e3]:
      ...
      - generic [ref=e14]:
        ...
        - button "Optimiser pour une offre" [active] [ref=e25]:
          - img [ref=e26]
    ...
    - complementary [ref=e70]:
      - generic [ref=e71]:
        - generic [ref=e72]:
          - img [ref=e74]
          - generic [ref=e77]:
            - heading "Match Offre d'Emploi" [level=2] [ref=e78]
            - paragraph [ref=e79]: Optimise ton CV pour ce poste
        - button [ref=e80]:
          - img [ref=e81]
      - generic [ref=e85]:
        - generic [ref=e86]: Colle le texte de l'offre d'emploi
        - textbox "Nous recherchons un développeur Frontend React avec 3 ans d'expérience..." [ref=e87]
        - button "Analyser la compatibilité" [disabled] [ref=e89]:
          - img [ref=e90]
