        ...
        <div className="bg-slate-900/80 backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 shadow-2xl">
          {isReset ? (
            <>
              ...
              <form className="space-y-4">
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white font-medium rounded-xl text-sm transition-all duration-200 hover:shadow-lg hover:shadow-indigo-600/25 active:scale-[0.98]"
                >
                  Envoyer le lien
                </button>
              </form>
            ...
            <>
              ...
              {/* Success message (e.g. after reset email sent) */}
              {message && (
                <div className="mb-4 px-4 py-3 bg-emerald-500/10 border border-emerald-500/30 rounded-lg text-emerald-400 text-sm">
                  {decodeURIComponent(message)}
                </div>
